...
import { translateXVariants, translateYPos } from "../animations";
const Footer = () => (
          ...
          >
            ...
            <ul className="list-none mt-4">
              {footerlink.links.map((link, index) => (
                <li
                  key={link.name}
                  className={`font-poppins font-normal footer-link text-[16px] leading-[24px] text-dimWhite hover:text-secondary hover:pl-1 ease-linear duration-300 cursor-pointer ${
